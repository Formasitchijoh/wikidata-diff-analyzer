...
class Total
  KEY_MAPPING = {
    ...
    added_language: :language_added,
    changed_language: :language_changed,
    added_lexical_category: :lexical_category_added,
    changed_lexical_category: :lexical_category_changed,
    ...
    added_form_references: :form_references_added,
    removed_form_references: :form_references_removed,
    changed_form_references: :form_references_changed,
    added_form_qualifiers: :form_qualifiers_added,
    removed_form_qualifiers: :form_qualifiers_removed,
    changed_form_qualifiers: :form_qualifiers_changed,
    ...
    added_sense_references: :sense_references_added,
    removed_sense_references: :sense_references_removed,
    changed_sense_references: :sense_references_changed,
    added_sense_qualifiers: :sense_qualifiers_added,
    removed_sense_qualifiers: :sense_qualifiers_removed,
    changed_sense_qualifiers: :sense_qualifiers_changed,
